...
const LanguageProvider: FC = ({ children }) => {
	const [languageCode, setLanguageCode] = useState<string>(LanguageCodes.English);
	...
	return (
		<LocalizationContext.Provider value={{ languageCode, locals: Localization[languageCode], changeLocale }}>
			{children}
